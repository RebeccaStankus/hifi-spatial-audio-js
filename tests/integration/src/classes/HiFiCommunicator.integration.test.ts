...
let stackname = process.env.STACKNAME;
let stackURL = `https://loadbalancer-${stackname}.highfidelity.io`;
let websocketEndpointURL = `wss://loadbalancer-${stackname}.highfidelity.io/dev/account:8001/`;
